            ...
            <div className="lg:col-span-2 w-full p-8 max-w-lg max-md:max-w-lg mx-auto">
              <form>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center">
                      ...
                      <label
                        htmlFor="remember-me"
                        className="ml-3 block text-[15px] text-slate-900"
                      >
                        Remember me
                      </label>
                    </div>
                ...
                <div className="mt-12">
                  <button
                    type="button"
                    className="w-full py-2.5 px-4 text-[15px] font-medium tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none cursor-pointer"
                  >
                    Sign in
                  </button>
                </div>
                ...
                <button
                  type="button"
                  className="w-full flex items-center justify-center gap-4 py-2.5 px-6 text-[15px] font-medium tracking-wide text-slate-900 border border-slate-300 rounded-md bg-slate-50 hover:bg-slate-100 focus:outline-none cursor-pointer"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20px"
